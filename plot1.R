...
# 4. generating an histogram on 'Global Active Power (kilowatts)" 
# 5. saving the result to "plot1.png"
#
#                    
#
...
# 
# output 
#    a histogram on the screen and its copy to a 480 x 480 png file called "plot1.png"
#
...
#
# 5. saving the result to a file 'plot1.png' of 480x480 pixels
#
print("saving the result to a file 'plot1.png' of 480x480 pixels...")
#
