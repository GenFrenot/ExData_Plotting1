...
# 5. saving the result to a file 'plot4.png' of 480x480 pixels
#
#                    
#
...
# 
# output 
#    a histogram on the screen and its copy to a 480 x 480 png file called "plot4.png"
#
...
plot.new()
# define four graph areas
par(mfrow=c(2,2)) 

# generate the chart in the first area
plot(Global_active_power ~ Time, data
	,type="l" 
	,xlab=""
	,ylab="Global Active Power")

# generate the chart in the second area
plot(Voltage ~ Time, data
	,type="l" 
	,xlab="datetime"
	,ylab="Voltage")

# generate the chart in the third area
with(data, {
...
# generate the chart in the fourth area
plot(Global_reactive_power ~ Time, data
	,type="l" 
	,xlab="datetime"
...
# 5. saving the result to a file 'plot4.png' of 480x480 pixels
#
print("saving the result to a file 'plot4.png' of 480x480 pixels...")
#
